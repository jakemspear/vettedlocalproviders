...
window.STRINGS.en.cost = {
  roofing: {
    ...
    crumbs: [{ label: "Home", href: "home2.html" }, { label: "Roofing", href: "Roofing.html" }, { label: "Cost guide" }],
...
window.STRINGS.es.cost = {
  roofing: {
    ...
    crumbs: [{ label: "Inicio", href: "home2.html" }, { label: "Techos", href: "Roofing.html" }, { label: "Guía de precios" }],
